import {useMemo,useEffect,useState,useContext,useLayoutEffect} from 'react';
...
export default function hosts() {
    ...
    const {user,isLoading,setisLoading,isAccessTokenValid,refreshAccessToken}=useContext(AuthContext)
  ...
  return <div className='flex flex-row justify-evenly'>
    ...
    {hostsList.map(v=><div className='border-2 flex flex-col w-72 h-min' key={v.id} >
